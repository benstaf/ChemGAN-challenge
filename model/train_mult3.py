...
from rollout_mult import ROLLOUT
...
#    ckpt_file = os.path.join(ckpt_dir, ckpt_dir + '_model')   #old checkpoint
    ckpt_file = os.path.join(ckpt_dir, PREFIX + '_model_')   #new checkpoint iterate over checkpoints to find largest total a
